...
class KpDetailSK extends StatefulWidget {
  List list;
  int index;
  KpDetailSK({this.index, this.list});

  @override
  _KpDetailSKState createState() => new _KpDetailSKState();
}

class _KpDetailSKState extends State<KpDetailSK> {
              ...
              child: new Column(
                children: <Widget>[
                  ...
                  MaterialButton(
                    ...
                    //       url:
                    //           "http://okenih.rapidserver.my.id/api/mahasiswa/kp/3",
