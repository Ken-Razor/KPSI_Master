...
import 'package:rpl_mobile/CRUD/tambahJadwal.dart';
            ...
            return ListView.builder(
              itemBuilder: (context, position) {
                return Card(
                  ...
                  child: Container(
                    child: ListTile(
                      title: Text(listjadwal[position].id_matkul +
                          " - " +
                          listjadwal[position].id_dosen),
                      subtitle: Text("NIDN : " +
                          listjadwal[position].nidn.toString() +
                          " - Hari " +
                          listjadwal[position].hari.toString() +
                          " - Sesi " +
                          listjadwal[position].sesi.toString() +
                          " - SKS : " +
                          listjadwal[position].sks.toString()),
                      onLongPress: () {
                        showDialog(
                            context: context,
