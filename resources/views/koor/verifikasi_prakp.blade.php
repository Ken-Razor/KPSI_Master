...
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">PRA KP</h1>
                    ...
                    <table class="table table-striped table-hover">
                      <thead>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        @if($dt->status == 1)
                                        <a href="{{ url('verifikasi/prakp/status/' . $dt->id) }}" class="btn btn-sm btn-danger">Tolak</a>
                                        @else
                                        <a href="{{ url('verifikasi/prakp/status/' . $dt->id) }}" class="btn btn-sm btn-success">Setuju</a>
                                        @endif
                                    </td>
