...
class DetailVerifikasiKp extends StatefulWidget {
  List list;
  int index;
  DetailVerifikasiKp({this.index, this.list});
  @override
  _DetailVerifikasiKpState createState() => new _DetailVerifikasiKpState();
}

class _DetailVerifikasiKpState extends State<DetailVerifikasiKp> {
  void updateStatus() {
    var url =
        "http://okenih.rapidserver.my.id/api/koor/verifikasi/kp/status/update";
    http.put(url, body: {
