...
class SKAddData extends StatefulWidget {
  @override
  _SKAddDataState createState() => new _SKAddDataState();
}

class _SKAddDataState extends State<SKAddData> {
  ...
  void addData() {
    var url = "http://okenih.rapidserver.my.id/api/mahasiswa/tambah/3";
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Tambah Data SK KP MU"),
      ),
      body: SafeArea(
        child: Padding(
