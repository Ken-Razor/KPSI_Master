...
class JadwalAddData extends StatefulWidget {
  @override
  _JadwalAddDataState createState() => new _JadwalAddDataState();
}

class _JadwalAddDataState extends State<JadwalAddData> {
  ...
  void addData() {
    var url = "http://okenih.rapidserver.my.id/api/mahasiswa/tambah/kp/3";
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            border: InputBorder.none,
                            hintText: 'Masukkan tools yang anda gunakan'),
                      ),
                    ),
                    SizedBox(
                      height: 15,
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            border: InputBorder.none,
                            hintText: 'Masukkan Dosen Penguji'),
                      ),
                    ),
                    SizedBox(
                      height: 15,
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            border: InputBorder.none,
                            hintText: 'Masukkan Ruang Ujian Anda'),
                      ),
                    ),
                    SizedBox(
                      height: 15,
                    ...
                    MaterialButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.of(context).pushReplacement(MaterialPageRoute(
                            builder: (BuildContext context) => PengajuanKP()));
                      },
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: <Widget>[
